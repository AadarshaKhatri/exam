...
public class Main {
    public static void main(String[] args) {
        ...
        Tshirt order1 = new Tshirt("Gorkhali Batman","123",1200,"thulo","welcome to my shop",new String[]{"XL","L","M"});
        Tshirt order2 = new Tshirt("Superman","123",1300,"kappa","welcome to my shop",new String[]{"XL","L","M"});
        Tshirt order3 = new Tshirt("Caption america","123",1400,"lew","welcome to my shop",new String[]{"XL","L","M"});
